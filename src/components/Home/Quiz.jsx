      ...
      <Container>
        <div className="bg-quiz-bg h-auto sm:bg-cover bg-center bg-no-repeat bg-[#6D9886] rounded-xl relative">
          <article className="py-24 md:px-14 px-4 md:w-9/12 md:mx-0 mx-auto md:text-left text-center leading-none">
            ...
            We empower you to manage your health effectively by providing daily tracking, reminders, and personalized guidance. 
            Our goal is to help you lead a healthier life, reduce the risk of severe conditions, and improve your overall well-being.
            </h3>
          </article>
