    ...
    <nav className="py-2 z-40">
      <Container>
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/Signup">
            <div className="hidden md:block hover:bg-button-primary px-1 py-1 rounded-xl" style={{marginLeft:"400px"}}>
              Sign Up
            </div>
          </Link>

          <Link to="/Login">
            <div className="hidden md:block hover:bg-button-primary px-2 py-1 rounded-xl">
              Login
            </div>
          </Link>
